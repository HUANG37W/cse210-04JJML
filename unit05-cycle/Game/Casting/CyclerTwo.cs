...
{
    /// <summary>
    /// <para>The Second Cycler which should spawn on the right of the screen.</para>
    /// <para>The responsibility of Cycler is to move itself.</para>
    /// </summary>
    public class CyclerTwo : Cycler
    {
        private List<Actor> segments = new List<Actor>();

        /// <summary>
        /// Constructs a new instance of a CyclerTwo.
        /// </summary>
        public CyclerTwo()
        {
            // PrepareBody();
        ...
        //     for (int i = 0; i < Constants.CyclerTwo_LENGTH; i++)
        //     {
